...
block = {'attn': np.array([576, 480, 384, 288]), 'mlp': np.array([1920, 1760, 1600, 1440, 1280, 1120, 960]), 'layer': None}  
block_skip = copy.deepcopy(block)
...
block = {'attn': np.array([768, 640, 512, 384]), 'mlp': np.array([3840, 3520, 3200, 2880, 2560, 2240, 1920]), 'layer': None}  
block_skip = copy.deepcopy(block)
