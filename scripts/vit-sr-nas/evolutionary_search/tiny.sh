...
MODEL_PATH="models/vit-sr-nas/super_net/tiny/example_per_arch@64/epoch@119_checkpoint.pth.tar"
...
python -m torch.distributed.launch --nproc_per_node=8 \
    ...
    --init-popu-size 500 \
    --mutate-size 75 \
    --output_dir models/vit-sr-nas/evolutionary_search/tiny/example_per_arch@64/mac@1.794G
