...
MODEL_PATH="models/vit-sr-nas/super_net/small/example_per_arch@64/epoch@119_checkpoint.pth.tar"
...
python -m torch.distributed.launch --nproc_per_node=8 \
    ...
    --constraint-value 4600000000 \
    --search-iter 20 \
    --parent-size 75 \
    --init-popu-size 500 \
    --mutate-size 75 \
    --output_dir models/vit-sr-nas/evolutionary_search/medium/example_per_arch@64/mac@4.6G
